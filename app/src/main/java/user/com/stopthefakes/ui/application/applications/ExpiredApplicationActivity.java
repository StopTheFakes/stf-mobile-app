...
public class ExpiredApplicationActivity extends BaseActivity {
	...
	public static Intent newInstance(Context context) {
		return new Intent(context, ExpiredApplicationActivity.class);
	}
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_application_expired_details);
		...
		if (id == -1) {
			Log.e("ExpiredApplication", "Id is empty (0)");
			openStartPage();
			return;
		}
